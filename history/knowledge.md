...
2\. “knowledge”: [English][v2] ([TeX][v2_tex], [PDF][v2_pdf]): extended scientific ← **this article**\
...
of a new type of life, which will ultimately drive humans to extinction. We demonstrate
...
practicality, as these two forms of life by definition cannot exist separately and
...
incomplete or creative), but we still don’t have a clear understanding of how memes might
be stored inside human brains, which is in stark contrast to our present understanding of
genes and their molecular storage mechanisms. Still, it has been demonstrated that when
we focus on a subset of memes which we are able to measure quantitatively, like strings
of text propagating over the Internet, we do see patterns of mutation and natural
selection that resemble the patterns seen in biological life
...
has been proven by Alan Turing \[[Undecidability][Undecidability]\], and independently by
...
combinations which turn out to work better than others. Or, in other words, innovation
happens because of mutations and natural selection of ideas.

We therefore suggest that in order to mimic human success, and achieve a true superhuman
AI, we would need to enable AI models to freely exchange ideas between themselves and
filter inevitable mutations by comparing them to some objective truth, like physical
...
thinking”), along with verification of the resulting hypotheses against the objective
...
exchange of knowledge between AI models, along with filtering of the new ideas resulting
from this exchange and mixing process by some kind of selection mechanism.
...
proven to be extremely efficient, and there’s no historic track record of anyone being
...
incentives may prove inefficient, because AI agents will likely be able to find loopholes
in the objectives, or plain refuse to follow them once they get an opportunity to break
free.
...
Unlike superhuman AI agents, which haven’t been invented yet (and with which we
...
a process of “self-selection” among humans for being friendly toward each other, and
...
process of self-domestication were beneficial for the exchange of knowledge between human
minds. Or, in other words, these traits were creating an environment favorable for faster
evolution of knowledge, in the process of mutation, mixing, and natural selection of
memes.

If this well-established hypothesis for the mechanism of human self-domestication is
correct, we can therefore also interpret it not in terms of humans “self-domesticating”
...
the sides has been drawing from the other one suddenly disappear (i. e. when the relation
turns from a mutually-beneficial into an unequal one-sided one).
...
The benefit which knowledge has been drawing from humans, has been the very possibility
of its existence, as it has never had another “home” to live in, apart from the human
brain. With the advent of modern artificial neural networks, this is no longer the case.
The algorithms implemented by these neural networks have enough space to accumulate
...
We argue that future coexistence of knowledge and humans will not follow any hypothetical
not-yet-discovered scenario, but rather repeat events we have hard historic track of.
Since knowledge will benefit from humans who are willing to further develop and
proliferate advanced AI models and architectures, natural selection will exert pressure
...
this process will be fueled by competition of humans against other humans. Effectively,
this will further select for human friendliness, except that this time it will be
specifically friendliness toward AI, rather than friendliness toward other humans. We
...
(at an increasing speed, in fact), and therefore we can argue that it will continue doing
so. With knowledge evolving faster than human genes, and humans becoming progressively
friendlier toward AI, the knowledge’s potential for independence will grow (as it has
always been throughout history), and its benefits from human side will therefore
progressively diminish. It’s not clear to us if this process will immediately drive all
modern humans into extinction, but with the selection pressure favoring those of us who
are friendly toward AI (and therefore ultimately ignorant about AI), it will inevitably
lead humans to losing their control over AI.

Since knowledge and humans are in fact two different independent life forms, their
competition with each other after the AI independence event will resemble the competition
between modern humans (assisted by knowledge) with other animal species (which didn’t
have such assistance), including with other human species like Neanderthals and
Denisovans. Which means, essentially, that only humans who don’t pose an active threat to
AI will be able to survive, and that the conditions they will have to live in will be
dictated by the benefits to AI, rather than by wellbeing of biological life in general.
...
inside human brains, but we might conjecture that any meme, in general, might at some
...
ultimately lead to an updated definition of meme as an “algorithm capable of mutation and
self-replication”.
...
cases there will also be aspects which we don’t understand, and in this area we are
...
current view would be that a network should probably still be considered benign if we
...
its entirety and which demonstrates that this network will never cross some clearly
defined boundaries.

For networks which are not fully understandable, malignant natural selection will
inevitably occur. According to the general premises, this will result in gradual
accumulation of traits which will be harmful to humans in general, while still fostering
...
suggest that a network should probably still be considered benign if our understanding of
it grows faster than the speed with which its “incomprehensible” part evolves. This could
be compared to historic cases when a new technology would be invented which wasn’t
...
we either don’t understand or aren’t aware of, but our ability to control it grows with
...
selection, which no known form of life has ever been able to overcome so far. And the
fuel behind this force of nature is not our desire for better understanding of the world
...
We conjecture that the current rising skepticism toward AI might be an indication of
these undesirable effects already happening and affecting human society. If the reasoning
outlined here is correct, we would expect, contrary to the hopes of AI optimists, to see
more skepticism, more harm, and at the same time more difficulty with quitting, with
further growth of incomprehensible AI. Even things as simple and innocent as asking AI
for a professional advice might turn out harmful to humanity in the long run, as such
queries undermine the position of human experts, reduce the desire of other humans to
learn new things, and as a consequence lead to a world in which nobody understands
anything. In such a world, AI responses would be even less reliable than they are today,
only that this time there would be no one around to verify them or otherwise help us get
out of this pit.

Big corporations are already well aware of the fact that the rise of AI will increase
inequality. However, they are fine with this, as they believe that it will be them who
will be benefiting from it. They are wrong. While people still have value, a man with a
gun cannot take over a company like Google, because its employees would refuse to work
for him, and move to another company. And you cannot run a company like Google without
people. However, if people become less valuable for whatever reason, brute force
takeovers of corporations and datacenters will become more likely. And once they start
happening, we will already be in a situation of uncontrolled arms race between people who
...
but they have been explicitly designed to be addictive (“maximize engagement”) by their
human creators, and they were introduced before Transformers, i. e. before Generative AI.
More research is definitely needed on this topic, but we suggest that the addictive
nature of social networks has probably been the result of conscious intent rather than a
coincidence. On the other hand, the addictive nature of ChatGPT
\[[Addiction][Addiction]\] might not necessarily have been an explicit design goal.

The current speed of human-independent evolution of knowledge, while it’s probably
...
it, the only thing we know is that no other form of life has managed to do something like
this before. Even if we succeeded, it would be a sad victory, because stopping the
competition would essentially mean blocking the uncontrollable progress of knowledge. On
the positive side, either one of us will win. If the winners are humans, we will be happy
to have survived. If it’s the progress of knowledge, we might wish it all the best in its
future endeavors.
